export const servicesData = [
    {
        ...
        "name2": "Development",
        "description":"Crafting stunning, responsive websites tailored to your brand's vision",
    ...
    },
    {
        ...
        "name1": "SaaS Product",
        "name2": "Engineering",
        "description":"End-to-end SaaS development for scalable, efficient business solutions",
    ...
    },
    {
        ...
        "description":"Building secure, decentralized applications to power the future of digital",
    ...
    },
    {
        ...
        "description":"Robust, high-performance backend services with cutting-edge technologies",
        "background": "h-[310px] p-12 bg-lime dark:bg-lime-800 rounded-[45px] shadow-card border border-black dark:border-white justify-between items-center flex text-black dark:text-white",
        "arrow": "./services/ag.svg",
        "link": "./",
    ...
    },
    {
        ...
        "name2": "Integration",
        "description":"Seamless API design and integration to connect and empower your software",
        "background": "h-[310px] p-12 bg-black dark:bg-gray-900 rounded-[45px] shadow-card border border-black dark:border-white justify-between items-center flex text-white",
        "arrow": "./services/ag.svg",
        "link": "./",
